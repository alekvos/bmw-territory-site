...
Сайт не принимает и не хранит заявки: посетитель связывается с сервисом напрямую по телефону либо через MAX, WhatsApp или Telegram.
...
- фотоматериалы услуг, блок прямой связи и загружаемая по запросу интерактивная карта;
